...
-- -----------------------------------------------------
-- Table `conferencedb`.`Events_has_Users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `conferencedb`.`Events_has_Users` ;

CREATE TABLE IF NOT EXISTS `conferencedb`.`Events_has_Users` (
  `Events_id` INT NOT NULL,
  `Users_id` INT NOT NULL,
  PRIMARY KEY (`Events_id`, `Users_id`),
  INDEX `fk_Events_has_Users_Users_idx` (`Users_id` ASC) VISIBLE,
